      ...
      <section className="relative bg-background py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/25 text-rose-600 text-[11.5px] font-bold tracking-wider uppercase px-4 py-1.5 rounded-full mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {FEATURES.map(({ icon: Icon, iconStyle, title, description, stat }) => (
              <div key={title} className="group relative flex flex-col gap-4 bg-card border border-white/8 rounded-4xl p-7 hover:-translate-y-1.5 hover:bg-card hover:border-orange-500/30 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all duration-300 overflow-hidden">
                ...
                <h3 className=" text-[1.1rem] font-bold dark:text-white text-black leading-tight">{title}</h3>
                <p className="text-[13.5px] text-black/45 dark:text-white/45 leading-relaxed flex-1">{description}</p>
                <div className="inline-flex items-center gap-1.5 bg-orange-500/10 border border-orange-500/20 text-black/55 dark:text-white/55 text-[11px] font-semibold px-3 py-1.5 rounded-full self-start">
          ...
          <div className="mt-10 bg-card border border-white/[0.07] rounded-4xl px-7 py-6 flex items-center justify-between flex-wrap gap-5">
            <div>
              <h3 className=" text-[1.2rem] font-bold text-black dark:text-white mb-1">Ready to order your first meal?</h3>
              <p className="text-[13.5px] text-black/40 dark:text-white/40">Join thousands of happy customers already using FoodHub</p>
            </div>
            <div className="flex gap-2.5 flex-wrap">
              ...
              <Link href="/providers" className="inline-flex items-center gap-2 h-10 px-5 rounded-2xl border border-gray/12 bg-transparent text-black/70 dark:text-white/70 text-[13.5px] font-semibold hover:bg-white/[0.07] hover:text-white hover:border-white/20 transition-all">
                View Providers
              </Link>
            </div>
          </div>
